...
AS
	...
	DECLARE @RETVAL int
	DECLARE @SECCION nvarchar(3), @SEPULTURA nvarchar(6), @TIPO nvarchar(2), @TITULAR nvarchar(50), @ULTBIMPAGO datetime, @RES_DIRECC nvarchar(50), @RES_CODPOS nvarchar(6), @RES_LOCALI nvarchar(20), @RESPONSABL nvarchar(50), @RES_EMAIL nvarchar(255), @RES_EMAIL_SEC nvarchar(255),@EST_OC varchar(30), @TIT_EMAIL nvarchar(255), @TIT_EMAIL_SEC nvarchar(255)
	...
	--BEGIN TRANSACTION
		...
		SELECT   SECCION, SEPULTURA, TIPO, TITULAR, ULTBIMPAGO, RES_DIRECC, RES_CODPOS, RES_LOCALI, RESPONSABL, RES_EMAIL,RES_EMAIL_SEC,estado_ocupacion,EMAIL,EMAIL_SEC
		FROM	 SAC_Lotes
		...
		-- MoveFirst
		FETCH NEXT FROM curLot INTO @SECCION, @SEPULTURA, @TIPO, @TITULAR, @ULTBIMPAGO,	@RES_DIRECC, @RES_CODPOS, @RES_LOCALI, @RESPONSABL, @RES_EMAIL,@RES_EMAIL_SEC,@EST_OC,@TIT_EMAIL,@TIT_EMAIL_SEC
		...
		BEGIN
			...
			BEGIN
				...
				INSERT INTO SAC_EstaLote
					(BIMESTRE, SECCION, SEPULTURA, TITULAR, ULTBIMPAGO, IMPORTE, DIRECCION, COD_POSTAL, LOCALIDAD, EMAIL, RESPONSABL, ENVIADO,EMAIL_SEC,EMAIL_RES,EMAIL_RES_SEC)
					VALUES (@intDeuda, @SECCION, @SEPULTURA, LEFT(@TITULAR, 40), @ULTBIMPAGO, @curImporte, @RES_DIRECC, @RES_CODPOS, @RES_LOCALI, @TIT_EMAIL,LEFT(@RESPONSABL, 40), NULL,@TIT_EMAIL_SEC,@RES_EMAIL,@RES_EMAIL_SEC)
