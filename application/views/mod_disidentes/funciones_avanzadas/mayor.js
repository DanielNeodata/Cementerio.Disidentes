...
function showReport() {
	...
	_AJAX.UiGetLibroMayor(myObj).then(function (datajson) {
		...
		win.document.body.innerHTML = "<html><title>Libro Mayor</title><body><img src='" + _AJAX._here + "/assets/img/print.jpg' style='height:35px;' onclick='window.print();'/><br/>Cementerio Disidentes <br/> Fecha: " + _TOOLS.getTodayDate("dmy", "/") + "<br/><h2 class='m-0 p-0' style='font-weight: bold; color: rgb(0,71,186);'><center>PERIODO " + titulo + "<br/>MAYOR DE LAS CUENTAS AL " + _TOOLS.getTodayDate("dmy", "/")+"</center></h2>" + _html + "</body></html>";
	});
