...
$html.="<div class='form-row'>";
$html.=getInput($parameters,array("col"=>"col-md-3","name"=>"NROTITULO","type"=>"text","class"=>"form-control text dbase "));
$html.="</div>";
$html.="<div class='form-row'>";
...
$html.="<hr/><br/><h4>Historial</h4>";
$html.="<div class='form-row'>";
$value=secureField($parameters["records"]["data"][0],"HISTORIA");

$html.=formatHtmlValue($value,"text");
//$html.=getInput($parameters,array("col"=>"col-md-3","name"=>"HISTORIA","type"=>"text","class"=>"form-control text dbase "));
$html.="</div>";
