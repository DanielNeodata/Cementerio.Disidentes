...
function showReport() {
	...
	_AJAX.UiGetArrendamientosXFecha(myObj).then(function (datajson) {
		var _html = "";
		...
		var total = Number(0);
		var filas = Number(0);
		$.each(datajson.arrendamientos, function (j, val1) {
