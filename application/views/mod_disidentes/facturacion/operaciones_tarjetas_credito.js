...
function getYears() {
	...
	_html += '<div class="row"><div class="col-12" style = "padding-top:15px;" ><a href="#" class="btnAction btnAccept btn btn-success btn-raised pull-right" onclick="previewMontosAGenerar();">Generación de recibos</a>    </div >    </div >';
