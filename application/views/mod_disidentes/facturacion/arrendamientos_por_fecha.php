...
?>
<script>
    $.getScript('./application/views/mod_disidentes/facturacion/arrendamientos_por_fecha.js', function() {
    });
</script>
<div class="container-full marco p-1">
    <div class="row mx-0 shadow rounded" style="background-color:whitesmoke;">
        <div class="col-12 pt-1 m-0">
            <h1 class="m-0 p-0" style="font-weight:bold;color:rgb(0, 71, 186);">Arrendamientos por fecha</h1>
        </div>
    </div>
