...
function showReport() {
	...
	var myJSON = '{"DESDE":"' + desde + '", "HASTA":"' + hasta + '", "PREFIJO":"' + prefijo + '", "DESTINO":"' + destino + '", "IDE":"' + IDE + '"}';
	...
	_AJAX.UiGetLibroDiarioHistorico(myObj).then(function (datajson) {
		var _html = "";
		...
		win.document.body.innerHTML = "<html><title>Libro Diario</title><body><img src='" + _AJAX._here + "/assets/img/print.jpg' style='height:35px;' onclick='window.print();'/><br/>Cementerio Disidentes <br/> Fecha: " + _TOOLS.getTodayDate("dmy", "/") + "<br/><h2 class='m-0 p-0' style='font-weight: bold; color: rgb(0,71,186);'><center>Libro Diario Histórico</center></h2>" + titulo + _html + "</body></html>";
	});
