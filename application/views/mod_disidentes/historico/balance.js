...
function showReport() {
	...
	_AJAX.UiGetBalanceHistorico(myObj).then(function (datajson) {
		var _html = "";
		...
		win.document.body.innerHTML = "<html><title>BALANCE HISTÓRICO DE SUMAS Y SALDOS</title><body><img src='" + _AJAX._here + "/assets/img/print.jpg' style='height:35px;' onclick='window.print();'/><br/>Cementerio Disidentes <br/> Fecha: " + _TOOLS.getTodayDate("dmy", "/") + "<br/><h2 class='m-0 p-0' style='font-weight: bold; color: rgb(0,71,186);'><center>PERIODO " + titulo + "<br/>BALANCE HISTÓRICO DE SUMAS Y SALDOS </center></h2>" + _html + "</body></html>";
	});
