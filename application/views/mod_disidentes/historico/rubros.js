...
function showReport() {
	...
	var myJSON = '{"DESDE":"' + desde + '", "HASTA":"' + hasta + '", "ID":"' + ID + '"}';
	var myObj = JSON.parse(myJSON);
	//alert("report2");

	_AJAX.UiGetRubrosHistoricos(myObj).then(function (datajson) {
		var _html = "";
